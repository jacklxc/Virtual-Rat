...
##SBATCH -o TestTrainingTime.o # File to which STDOUT will be written 
#SBATCH -e TestTrainingTimeFine.e # File to which STDERR will be written 
...
#SBATCH --output TestTrainingTime-log-%J-%a.txt
#SBATCH --array=0-99
## get tunneling info
XDG_RUNTIME_DIR=""
...
chmod 755 TestTrainingTimeFine.py
./TestTrainingTimeFine.py $SLURM_ARRAY_TASK_ID
