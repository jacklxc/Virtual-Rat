...
def meanPerformance(rats, trial_window = 3):
    ...
    p2a_mean /= len(rats)
    a2p_mean /= len(rats)
    p2a_left_mean /= len(rats)
    a2p_left_mean /= len(rats)
    p2a_right_mean /= len(rats)
    a2p_right_mean /= len(rats)

    return p2a_mean, a2p_mean, p2a_left_mean, a2p_left_mean, p2a_right_mean, a2p_right_mean
