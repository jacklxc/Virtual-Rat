...
for j in range(start, end):
    ...
    print ratname
    try:
        loaded_weights = load_weights("/scratch/xl1066/VirtualRat/poster/RatioTime/trainedTrainingTimeRatio-"+ str(switch_ratio)+"-"+str(j)+"-"+str(0)+".pkl")
        print ratname
    except IOError:
        continue
    ...
    for i in range(num_loop+1):
        ...
        loaded_weights = load_weights("/scratch/xl1066/VirtualRat/poster/RatioTime/trainedTrainingTimeRatio-"+ str(switch_ratio)+"-"+str(j)+"-"+str(i*epoch_per_loop)+".pkl")
...
save_weights("/gpfsnyu/home/xl1066/VirtualRat/poster/RatioTime/RatioTime-"+str(switch_ratio)+"-"+str(end)+".pkl",matrices)