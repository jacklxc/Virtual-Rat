...
accuracies, clfs = train_SGD(all_normalized_spike_count, SessionInfo, verbose=True)
...
normalized_table, session_table = make_tables(all_normalized_spike_count, SessionInfo,ratindex, clfs, 
	good_SGD_indices, normalize = True, verbose=True, time_steps=5)

sio.savemat('mats/SGD_table_overfit_all_normalized.mat',{'SGD_table':normalized_table})
sio.savemat('mats/SGD_session_table.mat',{'SGD_table':session_table})