% This script loads spike counts and check each cell's block trials' target 
...
%% Save cell_table
save('mats/single_cell_target_auc_p.mat','cell_table')

%% Save cell_table into python-readable array
single_target_AUC_p = table2array(cell_table(:,3:end));
save('mats/single_target_AUC_p.mat','single_target_AUC_p')