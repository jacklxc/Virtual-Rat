...
class SimpleRLPolicyGradientSolver(object):
    ...
    def __init__(self, model, env, **kwargs):
        ...
        self.stop = kwargs.pop('stop', True)
    ...
    def set_temperature(self, temp):
        self.model.params['temperature'] = temp
    ...
    def train(self):
        ...
        for episode_number in xrange(1, self.num_episodes):
            ...
            if "temperature" in self.model.params:
                self.temperature_history.append(self.model.params["temperature"])
            ...
            if self.stop and (self.running_reward / self.env.episode > 0.9):
                break
