...
#SBATCH -e RatioTime.e # File to which STDERR will be written 
...
##SBATCH --output TemporalCombo-log-%J.txt
#SBATCH --array=0-879
## get tunneling info
#XDG_RUNTIME_DIR=""
...
chmod 755 TrainRatioTime.py
./TrainRatioTime.py $SLURM_ARRAY_TASK_ID
